...
// Dominio del frontend en produccion (InfinityFree). Se deja fijo aqui,
// ademas de leerse desde CLIENT_URL, para que el CORS funcione incluso
// si la variable de entorno CLIENT_URL no llega a configurarse (o se
// configura mal) en el panel de Render. Si el frontend se muda a otro
// dominio en el futuro, agregalo a este arreglo.
const ALLOWED_ORIGINS = [
  'https://vblancor.great-site.net',
